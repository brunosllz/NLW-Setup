  ...
  return (
    <header className="w-full max-w-3xl mx-auto flex items-center justify-between">
      ...
      <Dialog.Root>
        <Dialog.Trigger
          type="button"
          className="border border-violet-500 hover:border-violet-300 font-semibold rounded-lg px-6 py-4 flex items-center gap-3 group transition-colors focus:outline-none focus:ring-2 focus:ring-violet-700 focus:ring-offset-2 focus:ring-offset-background "
        >
          Novo hábito
          <Plus
            size={20}
